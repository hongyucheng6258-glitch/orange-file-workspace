...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::import::list_task_items,
            ...
            commands::previews::get_preview_kind,
            commands::previews::get_resource_path,
            commands::previews::get_csv_preview,
            commands::previews::get_archive_listing,
